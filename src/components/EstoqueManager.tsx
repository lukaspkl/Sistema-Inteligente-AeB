...
// Cliente Supabase específico para estoque sem tipagem
const supabaseClient = createClient(
  'https://xvbqkhjwqhfksaunoamf.supabase.co',
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh2YnFraGp3cWhma3NhdW5vYW1mIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTQwOTIzMTYsImV4cCI6MjA2OTY2ODMxNn0.SRv1rs6PMjZB0DqDz-4y3xlg8xDXrxUFqLBbIVGFEUI'
);
